...
void mmm()
{
	...
	string oo = "C:\\Users\\EL10_gazy\\Downloads\\mmm\\*";
	char* pp = (char*)oo.c_str();

	hFind = FindFirstFile(pp, &ffd);
	...
	do
	{
		...
		temp_str = "C:\\Users\\EL10_gazy\\Downloads\\mmm\\" + temp_str + ".jpg";
		char* char_type = (char*)temp_str.c_str();


		rename(ffd.cFileName, char_type);
		i++;
